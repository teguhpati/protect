...
def help():
    ...
    helpMessage = "[▶️] " + key + " [TEGUH_BOT]\n" + \
                   ...
                   "[▶️]" + key + "Add @\n" + \
                   "[▶️]" + key + "Dell @\n" + \
                   "[▶️]" + key + "prokick on\off\n" + \
                   "[▶️]" + key + "projoin on\off\n" + \
                   "[▶️]" + key + "proinvite on\off\n" + \
                   "[▶️]" + key + "prourl on\off\n" + \
                   "[▶️]" + key + "Gs on\off\n" + \
                   "[▶️]" + key + "Bot1,2,3,4up\n" + \
                   "[▶️]" + key + "Pro on\off\n" + \
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2= "      「◀️PENGATURAN TBP▶️」\n" + \
                  "「▶️」 " + key + "ɪɴᴠɪᴛᴇ「ᴏɴ/ᴏғғ」\n" + \
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if msg.to in protectqr: md+="「▶️」Prourl「ON」🔛\n"
                                else: md+="「▶️」Prourl「OFF」📴\n"
                                if msg.to in protectjoin: md+="「▶️」Projoin「ON」🔛\n"
                                else: md+="「▶️」Projoin「OFF」📴\n"
                                if msg.to in protectjoin: md+="「▶️」Proinvite「ON」🔛\n"
                                else: md+="「▶️」Proinvite「OFF」📴\n"
                                if msg.to in protectkick: md+="「▶️」Prokick「ON」🔛\n"
                                else: md+="「▶️」Prokick「OFF」📴\n"
                                if msg.to in protectcancel: md+="「▶️」Procancel「ON」🔛\n"
                                else: md+="「▶️」Procancel「OFF」📴\n"
                                if msg.to in protectantijs: md+="「▶️」Js「ON」🔛\n"
                                else: md+="「▶️」Js「OFF」📴\n"  
                                if msg.to in ghost: md+="「▶️」Gs「ON」🔛\n"
                                else: md+="「▶️」Gs「OFF」📴\n"
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                        ...
                        elif cmd == "cannibal" or cmd == "teguh":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[▶️ TEGUH_PATI].")
                               elapsed_time = time.time() - start
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 1")
                                ki.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 2")
                                kk.sendMessage(msg.to, "[▶️ PAAUKAN TEGUH 3")
                                kc.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 4")
                                kb.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 5")
                                kd.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 6")
                                ke.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 7")
                                kf.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 8")
                                kj.sendMessage(msg.to, "[▶️ PASUKAN TEGUH 9")
                                sw.sendMessage(msg.to, "[▶️ PASUKAN YEGUH 10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========Hiburan============#
                        ...
                        elif cmd == "ckbot" or cmd == "teguhbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "cucianban" or text.lower() == 'dikumbah':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/D")
                        ...
                        elif cmd == "botdk-bot" or cmd == "tghbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[▶️TEGUH BOT].")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
